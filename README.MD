...
The engine it links, [kitwork/engine](https://github.com/kitwork/engine), is AGPL-3.0, so a
...
[Application Exception](https://github.com/kitwork/engine/blob/master/LICENSE-EXCEPTION.md).
